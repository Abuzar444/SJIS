...
const Hero = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home</title>
        <meta name='description' content={`Starting a business in Dubai can be a complex process, but we're here to simplify it for you. With our expertise and knowledge of the local business landscape`} />
        ...
        <div className="hidden h-[28rem] lg:carousel carousel-center p-4 space-x-4 bg-neutral rounded-box">
          <div className="carouse-item flex">
            {heroImages.map((image) => {
              return (
                <img src={image} className='rounded-box h-full w-80 object-cover' alt='our shop' width={100} height={100} />
              )
            })}
          </div>
        </div>
