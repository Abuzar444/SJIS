        ...
        <div>
          ...
          <div className='pl-10'>
            {aboutContent.map((cont, index) => {
              return (
                <div key={index}>
                  <h2 className='text-4xl font-bold bg-primary text-neutral w-60 my-2 rounded-md shadow-lg px-2 py-2'>{cont.title}</h2>
        ...
        <div>
          ...
          <div className='pl-10'>
            {aboutContent2.map((cont, index) => {
              return (
                <div key={index}>
                  <h2 className='text-4xl font-bold bg-primary text-neutral w-96 my-2 rounded-md shadow-lg px-2 py-2'>{cont.title}</h2>
                  <p className='text-md font-semibold'>{cont.content}</p>
                </div>
              )
            })}
