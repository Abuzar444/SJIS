            ...
            <div className="grid sm:grid-cols-2 h-full w-full align-element">
                <div className=" py-4 grid sm:grid-cols-2 gap-x-6  sm:gap-y-8 text-white text-center sm:text-left">
                    <div>
                        ...
                        {phoneContact.map((cont, index) => <p key={index} className="sm:py-6 py-3 flex-wrap flex items-center gap-2"><span className="text-primary text-xl">{cont.icon}</span>{cont.number}</p>)}
                    </div>
                    <div>
